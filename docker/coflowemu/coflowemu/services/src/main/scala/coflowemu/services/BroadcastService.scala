...
private[coflowemu] object BroadcastUtils {
...
private[coflowemu] case class BroadcastInfo(
    val coflowId: String, 
    val pathToFile: String, 
    val LEN_BYTES: Long)
private[coflowemu] case class BroadcastRequest()
private[coflowemu] case class BroadcastDone()

private[coflowemu] object BroadcastSender extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    val client = new CoflowemuClient("BroadcastSender", url, listener)
    client.start()
...
private[coflowemu] object BroadcastReceiver extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    val listener = new TestListener
    val client = new CoflowemuClient("BroadcastReceiver", url, listener)
    client.start()
