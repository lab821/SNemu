...
private[coflowemu] class BpsInfo {
  ...
  val OLD_FACTOR = System.getProperty("coflowemu.network.oldFactor", "0.2").toDouble
  val NIC_BPS = System.getProperty("coflowemu.network.nicMbps", "1024").toDouble * 1024.0 * 1024.0
