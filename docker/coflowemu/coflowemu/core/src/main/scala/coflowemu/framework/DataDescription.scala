...
private[coflowemu] object DataType extends Enumeration {
  type DataType = Value

  val FAKE, INMEMORY, ONDISK = Value
}

private[coflowemu] case class DataIdentifier(
    dataId: String, 
    coflowId: String)

private[coflowemu] class FlowDescription(
...
private[coflowemu] class FileDescription(
...
private[coflowemu] class ObjectDescription(
    val id_ : String,  // Expected to be unique within the coflow
