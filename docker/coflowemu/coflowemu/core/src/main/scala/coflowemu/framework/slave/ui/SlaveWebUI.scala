...
package coflowemu.framework.slave.ui
...
import coflowemu.framework.slave.SlaveActor
...
class SlaveWebUI(val slave: SlaveActor, val workDir: File, requestedPort: Option[Int] = None)
  ...
  implicit val timeout = Timeout(
    Duration.create(System.getProperty("coflowemu.akka.askTimeout", "10").toLong, "seconds"))
...
private[coflowemu] object SlaveWebUI {
